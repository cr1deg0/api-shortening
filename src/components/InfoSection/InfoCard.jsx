...
const InfoCard = ({ id, title, text, img_ref }) => {
  ...
  return (
    ...
    >
      <div
        className="absolute bg-violet-very-dark -top-12 card-icon-centered lg:left-8 p-6 rounded-full border"
      >
      ...
      <h5
        className="mt-12 lg:mt-16 mb-2 text-xl2 text-blue-very-dark font-bold"
      >
        { title }
      </h5>
      <p
